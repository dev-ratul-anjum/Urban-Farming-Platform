...
router.delete("/v1/community-posts/:id", adminAuth, AdminController.deleteCommunityPost);

// --- Order Management ---
router.get("/v1/orders", adminAuth, AdminController.getAllOrders);
router.patch("/v1/orders/:id", adminAuth, validateSchema(adminUpdateOrderSchema), AdminController.updateOrder);
...
router.patch("/v1/produces/:id", adminAuth, validateSchema(adminUpdateProduceSchema), AdminController.updateProduce);
router.delete("/v1/produces/:id", adminAuth, AdminController.deleteProduce);

// --- Rental Space Management ---
router.delete("/v1/rental-spaces/:id", adminAuth, AdminController.deleteRentalSpace);

// --- Sustainability Certificate Management ---
router.delete("/v1/sustainability-certs/:id", adminAuth, AdminController.deleteSustainabilityCert);
...
router.patch("/v1/bookings/:id", adminAuth, validateSchema(adminUpdateBookingSchema), AdminController.updateBooking);
router.delete("/v1/bookings/:id", adminAuth, AdminController.deleteBooking);

// --- Plant Tracking Management ---
router.get("/v1/plant-trackings", adminAuth, AdminController.getAllPlantTrackings);
router.delete("/v1/plant-trackings/:id", adminAuth, AdminController.deletePlantTracking);
